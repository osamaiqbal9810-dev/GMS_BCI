                                ...
                                <Grid sx={{ margin: 'auto', boxShadow: "0 0px 3px 0 rgb(118 134 154 / 90%)", padding: "16px" }} item xs={12} md={5}>
                                  {
                                    prefSrcAvail !== '' && standbySrcAvail !== '' ? <img src={
                                      prefSrcAvail === "Yes" && standbySrcAvail === "Yes" && !atsAtLocation.commStatus ? bothSource :
                                        prefSrcAvail === "Yes" && standbySrcAvail === "No" && !atsAtLocation.commStatus ? mainOn :
                                          standbySrcAvail === "Yes" && prefSrcAvail === "No" && !atsAtLocation.commStatus ? genOn : atsAtLocation.commStatus ? noSource : noSource
                                ...
                                <Grid sx={{ margin: 'auto', boxShadow: "0 0px 3px 0 rgb(118 134 154 / 90%)", padding: "16px" }} item xs={12} md={5}>
                                  {
                                    <img
                                      src={
                                        genStatus === 'Running' && !generatorAtLocation.commStatus
