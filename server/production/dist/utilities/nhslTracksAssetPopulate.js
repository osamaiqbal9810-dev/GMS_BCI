...
exports.trackAssetPopulateNSHL = undefined;
...
var trackAssetPopulateNSHL = exports.trackAssetPopulateNSHL = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
    var Track, subdiv, subDivExist, subDivCreate, templateQuery, track, _track, createdTrack, _templateQuery, _track2, _track3, _createdTrack, _templateQuery2, _track4, _track5, _createdTrack2;
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            //// ADD SUBDIVISION
            Track = ServiceLocator.resolve("TrackModel");
            subdiv = "Norristown";
            _context.prev = 2;
            _context.next = 5;
            return ApplicationLookupsModel.findOne({ description: subdiv, listName: "Subdivision" }).exec();

          case 5:
            subDivExist = _context.sent;
            ...
            _context.prev = 7;
            _context.next = 10;
            return ApplicationLookupsModel.create({
              tenantId: "ps19",
          ...
          case 14:
            ...
            console.log("ERROR CREATING 'Norristown' SUBDIVISION : " + _context.t0);
          ...
          case 19:
            ...
            console.log("ERROR FINDING 'Norristown' SUBDVISION : " + _context.t1);

          case 22:
            _context.prev = 22;
            templateQuery = Track.findOne({ trackId: "SEPTA-NT-01" });
            _context.next = 26;
          ...
          case 26:
            ...
            createAssets(track, _NHSLSEPTA.track1GIS);
            _context.next = 43;
            break;
          ...
          case 31:
            ...
            _context.prev = 32;
            _context.next = 35;
            return Track.create(_track);

          case 35:
            createdTrack = _context.sent;

            createAssets(createdTrack, _NHSLSEPTA.track1GIS);
            _context.next = 43;
            break;
          ...
          case 49:
            _context.prev = 49;
            _templateQuery = Track.findOne({ trackId: "SEPTA-NT-02" });
            _context.next = 53;
            return _templateQuery.exec();

          case 53:
            _track2 = _context.sent;
            ...
            createAssets(_track2, _NHSLSEPTA.track2GIS);
            _context.next = 70;
            break;
          ...
          case 58:
            ...
            _context.prev = 59;
            _context.next = 62;
            return Track.create(_track3);

          case 62:
            _createdTrack = _context.sent;

            createAssets(_createdTrack, _NHSLSEPTA.track2GIS);
            _context.next = 70;
            break;
          ...
          case 76:
            _context.prev = 76;
            _templateQuery2 = Track.findOne({ trackId: "SEPTA-NT-03" });
            _context.next = 80;
            return _templateQuery2.exec();

          case 80:
            _track4 = _context.sent;
          ...
          case 85:
            ...
            _context.prev = 86;
            _context.next = 89;
            return Track.create(_track5);

          case 89:
            _createdTrack2 = _context.sent;

            createAssets(_createdTrack2);
            _context.next = 97;
            break;

          case 93:
            _context.prev = 93;
            _context.t6 = _context["catch"](86);
    ...
    }, _callee, this, [[2, 19], [7, 14], [22, 45], [32, 39], [49, 72], [59, 66], [76, 99], [86, 93]]);
  }));

  return function trackAssetPopulateNSHL() {
    return _ref.apply(this, arguments);
  };
}();

var createAssets = function () {
  var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(track, trackGis) {
    var units, coord, result;
        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            if (track.trackId == "SEPTA-NT-01") {
              units = _NHSLSEPTA.track1Assets;
            } else if (track.trackId == "SEPTA-NT-02") {
              units = _NHSLSEPTA.track2Assets;
            ...
            if (trackGis) {
              coord = (0, _latlonCorrection.reverseLatLon)(trackGis);
            }
            track.units = units;
            track.units.unshift({
              assetType: "Rail",
  ...
  return function createAssets(_x2, _x3) {
    return _ref2.apply(this, arguments);
  };
}();

exports.lampNHSLAssets = lampNHSLAssets;
exports.addLampAssetsForNHSLT1 = addLampAssetsForNHSLT1;

var _NHSLSEPTA = require("./data/NHSLSEPTA");

var _UUID = require("./UUID");

var _latlonCorrection = require("./latlonCorrection");

var _lampT1NHSL = require("./data/lampT1NHSL");
...
var AssetTypeModel = require("./../api/assetTypes/assetTypes.model");
...
function lampNHSLAssets() {
  addLampAsset(lineAsset.unitId, lineAsset, function (err, obj) {
    var lineId = obj._id.toString();
    // track 1
    AssetModel.findOne({ unitId: 'track1' }).then(function (track1) {
      if (track1) {
        ...
        try {
          for (var _iterator = _NHSLSEPTA.track1Assets[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            var newAsset = {
              ...
              assetLenght: asset.end - asset.start,
    ...
    // track 2
    AssetModel.findOne({ unitId: 'track2' }).then(function (track2) {
      if (track2) {
        ...
        try {
          for (var _iterator2 = _NHSLSEPTA.track2Assets[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
function addLampAsset(unitId, newAst) {
  var createCallback = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : function (err, obj) {};
...
function addLampAssetTypes() {
  var possibleAssetTypes = ["Stone Xing", "speed change", "Gas Pipeline", "Platform", "Switch"];
  ...
  try {
    for (var _iterator3 = possibleAssetTypes[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
      var asttype = _step3.value;
  ...
  AssetModel.findOne({}, function (err, asset) {
    if (!asset) {
      ...
      (function () {
        ...
        try {
          for (var _iterator4 = _lampT1NHSL.lampT1NHSL[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
            lt1asset = _step4.value;
        ...
        try {
          for (var _iterator5 = _lampT1NHSL.lampT1NHSL[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
            lt1asset = _step5.value;

            AssetModel.create(lt1asset, function (err, lta) {
