...
exports.createSupportedDevices = undefined;
...
var createSupportedDevices = exports.createSupportedDevices = function () {
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.prev = 3;
                        _iterator = listOfSupportedDevices[Symbol.iterator]();
                    ...
                    case 5:
                        ...
                        sd = _step.value;
                        _context.next = 9;
                        return (0, _dbHelperMethods.addIfNotExist)(SupportedDevices, { type: sd.type, name: sd.name }, sd);
    ...
    return function createSupportedDevices() {
...
var SupportedDevices = require("../../../api/devices/devices.model");

var listOfSupportedDevices = [{
    type: "GENSET",
