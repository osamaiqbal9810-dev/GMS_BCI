...
export default class AppAccessService {
  constructor() {
    ...
    this.systemUserGroups = [
      { group_id: "manager", name: "Manager", permissions: [], isAdmin: false, level: 1, category: "Role" },
      { group_id: "inspector", name: "Inspector", permissions: [], isAdmin: false, level: 3, category: "Role" },
    ];
    this.relations = [
