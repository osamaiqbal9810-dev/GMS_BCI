...
import ListHelper from "./utilities/ListHelper.js";
import ThumbnailHelper from "./utilities/thumbnailHelper.js";
import DOValidator from "./service/DataOpValidationService.js";
import SODvalidator from "./service/SODOpValidator.js";

// API SERVICES
import ApplicationLookupsService from "./api/ApplicationLookups/ApplicationLookups.service.js";
import PermissionService from "./api/permission/permission.service.js";
import UserGroupService from "./api/userGroup/userGroup.service.js";

import DOEventService from "./service/DataOpEventService.js";
import DataOperationsLogic from "./service/DataOperationsLogic.js";

import AssetsService from "./api/assets/assets.service.js";
import AssetsTypeService from "./api/assetTypes/assetTypes.service.js";
import RunService from "./api/run/run.service.js";
import DashboardService from "./api/dashboard/dashboard.service.js";

import DeviceService from "./api/devices/devices.service.js";
import SupportedParams from "./api/SupportedParams/params.service.js";
import TilesService from "./api/SummaryTiles/tiles.service.js";
import AssetsTreeService from "./api/assetsTree/assetsTreeService.js";
import WorkOrderService from "./api/workOrder/WorkOrder.service.js";
import LocationService from "./api/Location/location.service.js";
import SensorLogService from "./api/sensorLog/sensorLog.service.js";
import VoiceAssistantService from "./api/voiceAssistant/voiceAssistant.service.js";
import SensorReportService from "./api/sensorReport/sensorReport.service.js";

// Import Timps
import { timpsApp, timpsStatus } from "./timps/timps.js";

import DatabaseSerivce from "./service/DBService.js";
import AppAccessService from "./service/AppAccessClass.js";
import RemedialActionListHook from "./api/ApplicationLookups/RemedialActionListHook.js";
import SchedulerService from "./service/SchedulerService.js";
import AlertService from "./api/Alert/Alert.service.js";
import NotificationService from "./api/Notification/Notification.service.js";
import DateTimeService from "./service/DateTimeService.js";
import SensorSimulatedData from "./service/SensorDataSImulaterService.js";
import StateManager from "./service/StateManager.js";
import {updateEventsList} from "./config/database/configurations/updateEventsList.js";
//Utils
//import { permChecker } from "./utilities/permCheck.js";
...
let supportedParams = new SupportedParams();
ServiceLocator.register("SupportedParams", supportedParams);

let tilesService = new TilesService();
ServiceLocator.register("TilesService",tilesService);

let databaseSerivce = new DatabaseSerivce();
...
let voiceAssistantService = new VoiceAssistantService();
  ...
  httpApp.get("*", (req, res) => {
    if (!req.secure) {
      ...
      if (req.headers.host === config.domain_name || req.headers.host === config.ip) {
        let redirect_url = config.server_comm_protocol + "://" + req.headers.host + req.url;
...
// update events push-notif and messages v 1.1
updateEventsList();
/**
...
schedule.scheduleJob("NotificationCronJob", "*/1 * * * *", async (fireDate) => {
  ...
  notificationService.delete3MonthOldNotif();
  dashboardService.deleteTwoDayOldRecs();
  notificationService.sendNewNotifications();
  tilesService.reportLocationToOffline()
});
...
let sensorLogSimulated = new SensorSimulatedData();
