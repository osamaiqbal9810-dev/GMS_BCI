                  ...
                  <div>
                    {
                      <img
                        src={
                          prefSrcAvail === 'Yes' && standbySrcAvail === 'Yes' && !atsDevices.commStatus
                            ? bothSource
                            : prefSrcAvail === 'Yes' && standbySrcAvail === 'No'&& !atsDevices.commStatus
                              ? mainOn
                              : standbySrcAvail === 'Yes' && prefSrcAvail === 'No' && !atsDevices.commStatus
                                ? genOn
                                : noSource
                        }
                        alt="power source"
                  ...
                  <div>
                    {
                      <img
                        src={
                          genStatus === 'Running' && !genDevices.commStatus
